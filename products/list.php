                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-group">
                                                <a href="./products/edit.php?id=<?= (int)$product['id'] ?>" class="action-btn edit-btn">Edit</a>
                                                <a href="./products/delete.php?id=<?= (int)$product['id'] ?>" class="action-btn delete-btn" data-confirm="Are you sure you want to delete this product?">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
