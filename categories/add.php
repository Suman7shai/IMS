        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav" aria-label="Dashboard menu">
                ...
                <div class="nav-item has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="./add.php">Add Categories</a></li>
                        <li><a href="./list.php">List Categories</a></li>
                    </ul>
                </div>
                <div class="nav-item has-submenu">
        ...
        <div class="dashboard-shell page-shell">
            <header class="dashboard-header">
                <div>
                    ...
                    <h1>Add Category</h1>
                    <p class="subtitle">Create a new product category for organizing inventory items.</p>
                </div>
            </header>
